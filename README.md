...
## 1일차
- C# 소개
    - NS에서 개발한 차세대 프로그래밍 언어
    - 2000년 최초 발표, 앤더스 하일버그(파스칼, 델파이 개발자)
    - 1955년 Java 발표되면서 경쟁하기 위해서 개발
...
- Hello, C#!
    ...
    namespace hello_world // 소스의 가장 큰 단위 namespace == project
    {
        internal class Program // 접근제한자 class 파일명
      {
            ...
            {
                // System 네임스테이스 > Console 클래스에 있는 정적메서드 WriteLine()
...
- 흐름제어
    - C++과 동일!
    - of, switch, while, do ~ while, for 모두 동일!!
...
- 메서드(Method)
    ...
    - 매서드 오버로딩 -> 여러타입으로 같은 처리를 하는 메서드를 여러개 만들 때
...
- 클래스 
    ...
    - 접근한정자(Access Modifier)
        ...
        - protucted internal, private protected - 난이도 있는 한정자(고급)
...
- 인터페이스
    ...
    - 인터페이스에서 약속한 메서드를 구현 안 하면 빌드 안됨!

    ![인터페이스설명](https://github.com/MsgIsJmt/basic-csharp-2024/blob/main/images/cs001.png)
...
- TIP, C# 에서 빌드 시 오류 프로세스 액세스 오류
    ...
    - Ctrl + Shift + ESC(작업관리자) 에서 해당 프로세스를 작업 끝내기 후
    - 재빌드 
...
- TIP, C# 주석 중 영역을 지정할 수 있는 주석
    - #region ~ #endregion 영역을 Expend 또는 collapse 가능
        ...
        ![region주석](https://github.com/MsgIsJmt/basic-csharp-2024/blob/main/images/cs002.png)
...
- 가비지 컬렉션
    - C, C++은 메모리 사용시 개발자가 직접 메모리 해체 해야함
...
- 윈폼 UI 개발 + 파일, 스레드
    ...
    - 그래픽 사용자 인터페이스를 만드는 방법
        1. Windows Forms(Windows Forms)
        2. WPF(Windows Presentation Foundation)
    - WYSIWG(What You See Is What You Get) 방식의 GUI 프로그램 개발
...
- 윈폼 UI 개발 (계속)
    ...
    - 파일 입출력 추가
        ...
        <img src = "https://github.com/MsgIsJmt/basic-csharp-2024/blob/main/images/cs003.png" width="850">
...
- 토이 프로젝트
    - 윈도우 탐색기 앱(컨트롤학습)
        ...
        ![중간결과](https://github.com/MsgIsJmt/basic-csharp-2024/blob/main/images/cs005.png)
