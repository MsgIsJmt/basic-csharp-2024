namespace ex19_asyncs
{
    public partial class FrmMain : Form
    {
        ...
        private async void BtnAstncCopy_Click(object sender, EventArgs e)
        {
        ...
        {
            // 버튼 사용 비활성화
            BtnSyncCopy.Enabled = BtnAstncCopy.Enabled = false;
            long totalCopied = 0;
            ...
            BtnSyncCopy.Enabled = BtnAstncCopy.Enabled = true;
