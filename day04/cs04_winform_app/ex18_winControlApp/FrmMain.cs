...
namespace ex18_winControlApp
{
    public partial class FrmMain : Form
    {
        ...
        void ChangeFont()
        {
            ...
            FontStyle style = FontStyle.Regular; // 일반 글자(볼듵, 이탤릭X)로 초기화
        ...
        private void BtnModaless_Click(object sender, EventArgs e)
        {
            ...
            // 모달리스창을 부모 정중앙에 위치할 떄는 아래와 같이 작업해야 함
            ...
            FrmModaless.Location = new Point(this.Location.X + (this.Width - FrmModaless.Width) / 2,
                                            (this.Height - FrmModaless.Height) / 2);
        ...
        // 일반텍스트파일 로드 이벤트핸들러
        private void BtcFileLoad_Click(object sender, EventArgs e)
        {
